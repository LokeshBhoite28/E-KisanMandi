...
class AddCrop extends Component {
    ...
    addCrop = (event) => {
        ...
        FarmerService.addCropDetails(this.state.farmerId, crop).then((response) => {
            console.log(response.data);
            this.props.history.push("/farmerProfile");
        }).catch((error) => { // error is a Promise
            console.log('in add crop error catch block');
                ...
                <div className='main1' >
                    ...
                    <Form noValidate validated={this.state.validated}>
                        <Row>
                            ...
                            <Col>
                                <Button variant="primary" type="submit" onClick={this.addCrop}>
                                    Add Crop
                                </Button>
                            </Col>
